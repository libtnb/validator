...
func ZhHant() map[string]string {
	return map[string]string{
		...
		"required_with_all":    "當 {0+} 均存在時 {field} 為必填欄位",
		"required_without_all": "當 {0+} 均不存在時 {field} 為必填欄位",
		"excluded_if":          "當 {0} 為 {1+} 時 {field} 必須為空",
		"excluded_unless":      "除非 {0} 為 {1+}，否則 {field} 必須為空",
		"excluded_with":        "當 {0} 存在時 {field} 必須為空",
		"excluded_without":     "當 {0} 不存在時 {field} 必須為空",
		...
		"cidr":            "{field} 必須是有效的 CIDR",
		"cidrv4":          "{field} 必須是有效的 IPv4 CIDR",
		"cidrv6":          "{field} 必須是有效的 IPv6 CIDR",
		"json":            "{field} 必須是有效的 JSON",
		"datetime":        "{field} 必須是有效的日期時間",
		"date":            "{field} 必須是有效的日期",
		"after":           "{field} 必須晚於 {0}",
		"after_or_equal":  "{field} 必須晚於或等於 {0}",
		"before":          "{field} 必須早於 {0}",
		"before_or_equal": "{field} 必須早於或等於 {0}",
		...
		"fqdn":            "{field} 必須是有效的完整網域名稱",
		"e164":            "{field} 必須是有效的 E.164 電話號碼",
		"semver":          "{field} 必須是有效的語意化版本號",
		"jwt":             "{field} 必須是有效的 JWT",
		"hexcolor":        "{field} 必須是有效的十六進位顏色",
		"latitude":        "{field} 必須是有效的緯度",
		"longitude":       "{field} 必須是有效的經度",
		"port":            "{field} 必須是有效的連接埠號",
		"luhn":            "{field} 未通過 Luhn 驗證",
		"credit_card":     "{field} 必須是有效的信用卡號",
		"ext":             "{field} 必須是以下類型的檔案：{0+}",
		"mimetypes":       "{field} 必須是以下類型的檔案：{0+}",
		"filemin":         "{field} 檔案不能小於 {0}",
		"filemax":         "{field} 檔案不能大於 {0}",
		...
		"eq":             "{field} 必須等於 {0}",
		"ne":             "{field} 不能等於 {0}",
		"eq_ignore_case": "{field} 必須等於 {0}",
		"ne_ignore_case": "{field} 不能等於 {0}",
		"unique":         "{field} 存在重複值",
		"same":           "{field} 與 {0} 必須一致",

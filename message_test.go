...
func TestMessageParamSubstitution(t *testing.T) {
	v := MustNew()
	vd := v.MustMap(map[string]any{"age": "3"}, map[string]string{"age": "min:5"})
...
func TestMessageAttributeAlias(t *testing.T) {
	v := MustNew(WithAttributes(map[string]string{"email": "Email Address"}))
	vd := v.MustMap(map[string]any{"email": "nope"}, map[string]string{"email": "email"})
	vd.Validate(context.Background())
...
func TestMessageOverridePriority(t *testing.T) {
	v := MustNew(WithMessages(map[string]string{
		"email.required": "field-level message",
		"required":       "rule-level message",
	}))

	// field-level override wins for email
	em := v.MustMap(map[string]any{}, map[string]string{"email": "required"})
	...
	nm := v.MustMap(map[string]any{}, map[string]string{"name": "required"})
...
func TestMessageI18n(t *testing.T) {
	v := MustNew(WithTranslation(translations.ZhHans()))
	vd := v.MustMap(map[string]any{"email": "nope"}, map[string]string{"email": "email"})
	vd.Validate(context.Background())
...
func TestMessageI18nCompositeOr(t *testing.T) {
	v := MustNew(WithTranslation(translations.ZhHans()))
	vd := v.MustMap(map[string]any{"x": "!!"}, map[string]string{"x": "alpha || numeric"})
	vd.Validate(context.Background())
...
func TestMessageOverrideBeatsTranslation(t *testing.T) {
	...
	vd := v.MustMap(map[string]any{}, map[string]string{"x": "required"})
	vd.Validate(context.Background())
...
func TestTranslatorFunc(t *testing.T) {
	v := MustNew(WithTranslator(func(rule string) (string, bool) {
		if rule == "required" {
	...
	fall := v.MustMap(map[string]any{"x": "nope"}, map[string]string{"x": "email"})
	...
	bd := both.MustMap(map[string]any{}, map[string]string{"y": "required"})
...
func (rawArgFallibleRule) Message() string { return "r6raw failed" }
...
func TestTransformFuncPanicRecovered(t *testing.T) {
	v := MustNew(WithTransformFunc(func(string) string { panic("boom") }))
	vd := v.MustValue("", "notblank")
	vd.Validate(context.Background())
	if !vd.Fails() {
	...
	pv := MustNew(WithParallel(1), WithTransformFunc(func(string) string { panic("boom") }))
	pd := pv.MustMap(map[string]any{"a": "", "b": ""}, map[string]string{"a": "notblank", "b": "notblank"})
...
func TestEmptyMessageFallback(t *testing.T) {
	v := MustNew(WithoutBuiltinRules(),
		WithRuleFunc("mr", func(*Field) bool { return false }, ""))
	vd := v.MustValue("x", "mr")
	vd.Validate(context.Background())
...
func (r failingFallibleRule) Message() string { return "forced fail" }

func TestCustomFallibleRule(t *testing.T) {
	v := MustNew(WithoutBuiltinRules(), WithFallibleRules(failingFallibleRule{sig: "alpha"}))
	vd := v.MustValue("abc", "alpha")
	vd.Validate(context.Background())
	if !vd.Fails() {
		t.Error("custom error rule should fail")
	}
}
...
func TestAddMessagesPerValidation(t *testing.T) {
	v := MustNew(WithMessages(map[string]string{"required": "global"}))
	...
	sib := v.MustMap(map[string]any{}, map[string]string{"name": "required"})
...
func TestAddMessagesFieldRulePriority(t *testing.T) {
	v := MustNew()
	vd := v.MustMap(map[string]any{}, map[string]string{"email": "required", "name": "required"})
...
func TestAddMessagesMergeAndCopy(t *testing.T) {
	v := MustNew()
	vd := v.MustMap(map[string]any{}, map[string]string{"a": "required", "b": "required"})
...
func TestAddMessagesBeatsTranslation(t *testing.T) {
	...
	nop := v.MustMap(map[string]any{}, map[string]string{"x": "required"})
